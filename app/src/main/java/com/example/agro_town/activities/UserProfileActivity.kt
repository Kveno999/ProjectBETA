...
class UserProfileActivity : BaseActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (mUserDetails.profileCompleted == 0){
            ///title_text.text = resources.getString(R.string.title_complete_profile)
                ...
                R.id.button_save ->{
                    ...
                    if (validateUserProfileDetails()) {
                        ...
                        if (mSelectedImageFileUri != null) {
                            ...
                            FirebaseDatabase.getInstance("https://agro-town-default-rtdb.europe-west1.firebasedatabase.app/").getReference().child("user")
            ...
            if (requestCode == Constans.PICK_IMAGE_REQUEST_CODE) {
                if (data != null) {
                    try {
                        ...
                        //img_profile.setImageURI(Uri.parse(selectedImageFileUri.toString()))
